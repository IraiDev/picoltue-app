...
const Harvest = () => {
   ...
   const [{ dateTo, dateFrom }, onChangeDate, resetDate] = useForm({
      dateTo: today,
      dateFrom: date_from,
   })
   ...
   const { lecturas, kilos_filtro, kilos_totales, total_lecturas_filtro, total_lecturas } =
      cosechas
   // destructuring
   ...
   const OnSearchForDate = () => {
      if (moment(dateFrom).isAfter(dateTo)) {
         Alert({
            ...
            title: 'Atencion',
            content:
               'Fecha desde no puede ser mayor a fecha hasta, por favor seleccione otro rango de fechas',
                     ...
                     <th colSpan={2}>
                        <div className="flex items-center gap-2 rounded-md bg-gray-300 p-1 mr-1">
                           ...
                           <Select
                              ...
                              onChange={onChangeValues}
                              showAllOption={
                                 filterName === '' && filterRut === '' && filterUser === ''
                              }
                  ...
                  {Object.keys(cosechas).length > 0 &&
                     lecturas.map((l, i) => (
                        <tr key={i} className="text-gray-700 text-sm border-b w-max">
                           ...
                           <Td
                              className="w-max"
                              children={moment(l.fecha_hora_lect).format('DD-MM-YYYY, HH:MM:ss')}
                           />
